...
class HighResolutionNet(nn.Module):
    def __init__(self, **kwargs):
        ...
        self.stage1_cfg = {'NUM_MODULES': 1, 'NUM_BRANCHES': 1, 'BLOCK': Bottleneck, 'NUM_BLOCKS': [
            4], 'NUM_CHANNELS': [64], 'FUSE_METHOD': 'SUM'}
        ...
        self.stage2_cfg = {'NUM_MODULES': 1, 'NUM_BRANCHES': 2, 'BLOCK': BasicBlock, 'NUM_BLOCKS': [
            4, 4], 'NUM_CHANNELS': [48, 96], 'FUSE_METHOD': 'SUM'}
        ...
        self.stage3_cfg = {'NUM_MODULES': 4, 'NUM_BRANCHES': 3, 'BLOCK': BasicBlock, 'NUM_BLOCKS': [
            4, 4, 4], 'NUM_CHANNELS': [48, 96, 192], 'FUSE_METHOD': 'SUM'}
        ...
        self.stage4_cfg = {'NUM_MODULES': 3, 'NUM_BRANCHES': 4, 'BLOCK': BasicBlock, 'NUM_BLOCKS': [
            4, 4, 4, 4], 'NUM_CHANNELS': [48, 96, 192, 384], 'FUSE_METHOD': 'SUM'}
